<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('access')" :active="request()->routeIs('access')">
                {{ __('access') }}
            </x-responsive-nav-link>
            @if (Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.slots.index')" :active="request()->routeIs('admin.slots.*')">
                    予約枠管理
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.slot-rules.index')" :active="request()->routeIs('admin.slot-rules.*')">
                    自動生成ルール
                </x-responsive-nav-link>
            @endif
        </div>
