                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.plans.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            {{-- 提供期間 --}}
                            <div>
                                <x-input-label value="提供期間（空白で期間制限なし）" />
                                <div class="flex items-center gap-3 mt-1">
                                    <div class="flex-1">
                                        <x-input-label for="available_from" value="開始日" class="text-xs text-gray-500" />
                                        <x-text-input id="available_from" name="available_from" type="date" class="mt-1 block w-full" :value="old('available_from')" />
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <x-text-input id="available_to" name="available_to" type="date" class="mt-1 block w-full" :value="old('available_to')" />
